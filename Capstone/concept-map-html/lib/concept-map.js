...
var a=1000,c=1000,h=c,U=200,K=22,S=20,s=8,R=110,J=30,o=15,t=10,w=1000,F="elastic",N="#0da4d3";var T,q,x,j,H,A,P;var L={},k={};var i,y;
var r=d3.layout.tree().size([360,h/4-R]).separation(function(Y,X){return(Y.parent==X.parent?1:2)/Y.depth});
